/*
  # Schema update for service booking platform
  ...
  2. Security
    ...
    - Add policies for data access control based on user roles
...
-- Remover triggers existentes se existirem (para evitar conflitos)
